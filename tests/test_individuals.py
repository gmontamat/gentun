...
def test_validate_params():
    ...
    with pytest.raises(ValueError):
        Individual(genes, handler, x_train, y_train, hyperparameters)
    ...
    kwargs = {"param4": "4"}
    with pytest.raises(TypeError):
        Individual(genes, handler, x_train, y_train, hyperparameters, **kwargs)
...
def test_reproduce():
    ...
    individual1 = Individual(genes, handler, x_train, y_train, hyperparameters1)
    individual2 = Individual(genes, handler, x_train, y_train, hyperparameters2)
